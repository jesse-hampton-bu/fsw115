...
let myDataList = document.getElementById("list")

for (var i = 0; i < myData.length; i++) {
    myDataList.innerHTML +=  "<li>" + myData[i].name + " : " + myData[i].eye_color  + " : " + myData[i].skin_color + "</li>"
                            // <li>Name : Eye color : skin color</li>
}